...
def test_worlds_listing_contract_identifier_did_not_move():
    ...
    dense and surface fields had to be additive and this string had to stay
    put across both.

    The literal was `world_builder.worlds/2026-09-06` when the dense lane
    wrote this test. It is now `2026-09-10` because the live/history lane
    bumped it for a reason of its own -- a genuine change to the listing's
    shape -- which is exactly the kind of move this test is supposed to
    permit. What it forbids is a reconstruction stage bumping it, and
    neither did.
    """
